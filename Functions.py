...
def analysis(file):
    ...
    sample_comparisons = [comb for comb in list( combinations(list(product(values["Group"].unique(), values["Time"].unique(), weights)), 2 ) ) if not (comb[0][0] == comb[1][0] and comb[0][1] == comb[1][1] and comb[0][2] != comb[1][2])]
