...
Templates = c("/Testbed/Inputs/Template - Crosstabs.docx", "/Testbed/Inputs/Template - Report.docx")
...
Report_Demographic = "Political Party Preference"
{
  ...
  repeat{
    ...
    {
      if(Demographic_Category == Report_Demographic){Export_Report(Outputs, Crosstabs, File_Name, Name_Group, Demographic_Category)}
    }
